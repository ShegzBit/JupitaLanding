          ...
          <div className="relative z-10">
            ...
            >
              <span className="inline-block px-4 py-1 rounded-full bg-[hsl(var(--jupita-primary))]/10 text-[hsl(var(--jupita-primary))] font-medium text-sm mb-5">
                Fintech Solutions for Smart Lenders
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                Transform Your <br />
                <span className="text-[hsl(var(--jupita-primary))]">
                  Credit
                </span>{" "}
                <br />
                Operations
              ...
              <p className="text-[hsl(var(--jupita-gray))] text-lg mb-8 max-w-lg">
                Jupita delivers tailored SaaS platforms that streamline loan
                origination, customer onboarding, and credit risk assessment for
                Smart Lenders.
              </p>
            </motion.div>
            <motion.div
                ...
                <div className="px-6 pb-6 -mt-20">
                  <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-[hsl(var(--jupita-gray))] text-sm">
                          Simplified workflow
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="text-right text-xs text-[hsl(var(--jupita-gray))]">
                      80% complete
                    </div>
                  </div>
                  <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-4">
                        <h3 className="font-medium">Bank Statement Analysis</h3>
                        <p className="text-[hsl(var(--jupita-gray))] text-sm">
                          AI driven analytic data
                        </p>
                      </div>
                    </div>
                    <div className="grid grid-cols-4 gap-2">
                      ...
                      <div
                        className="h-10 bg-gray-100 rounded animate-pulse-slow"
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <a
                      ...
                      className="rounded-lg py-2 px-4 bg-[hsl(var(--jupita-primary))] text-white text-sm font-medium"
                    >
                      View Demo
                    </a>
                  </div>
